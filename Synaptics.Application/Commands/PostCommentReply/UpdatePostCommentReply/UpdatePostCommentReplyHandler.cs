...
public class UpdatePostCommentReplyHandler : IRequestHandler<UpdatePostCommentReplyCommand, Response>
{
    ...
    public UpdatePostCommentReplyHandler(IUnitOfWork unitOfWork, IHttpContextAccessor contextAccessor, UserManager<Entities.AppUser> userManager, IMapper mapper)
    {
    ...
    public async Task<Response> Handle(UpdatePostCommentReplyCommand request, CancellationToken cancellationToken)
    {
