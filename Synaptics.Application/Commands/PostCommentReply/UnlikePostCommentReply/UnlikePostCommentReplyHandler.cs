...
public class UnlikePostCommentReplyHandler : IRequestHandler<UnlikePostCommentReplyCommand, Response>
{
    readonly IUnitOfWork _unitOfWork;
    readonly IHttpContextAccessor _contextAccessor;
    readonly UserManager<Entities.AppUser> _userManager;

    public UnlikePostCommentReplyHandler(IUnitOfWork unitOfWork, IHttpContextAccessor contextAccessor, UserManager<Entities.AppUser> userManager)
    {
    ...
    public async Task<Response> Handle(UnlikePostCommentReplyCommand request, CancellationToken cancellationToken)
    {
