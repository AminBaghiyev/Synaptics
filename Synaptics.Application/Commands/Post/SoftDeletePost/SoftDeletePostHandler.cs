...
public class SoftDeletePostHandler : IRequestHandler<SoftDeletePostCommand, Response>
{
    readonly IUnitOfWork _unitOfWork;
    readonly IHttpContextAccessor _contextAccessor;
    readonly UserManager<Entities.AppUser> _userManager;

    public SoftDeletePostHandler(IUnitOfWork unitOfWork, IHttpContextAccessor contextAccessor, UserManager<Entities.AppUser> userManager)
    {
    ...
    public async Task<Response> Handle(SoftDeletePostCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            _unitOfWork.PostRepository.SoftDelete(post);
