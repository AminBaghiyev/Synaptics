...
public class HardDeletePostHandler : IRequestHandler<HardDeletePostCommand, Response>
{
    readonly IUnitOfWork _unitOfWork;
    readonly IHttpContextAccessor _contextAccessor;
    readonly UserManager<Entities.AppUser> _userManager;

    public HardDeletePostHandler(IUnitOfWork unitOfWork, IHttpContextAccessor contextAccessor, UserManager<Entities.AppUser> userManager)
    {
    ...
    public async Task<Response> Handle(HardDeletePostCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (post.UserId != user.Id)
            {
                ...
                return new Response
                {
                    ...
                    MessageCode = MessageCode.YouArentAllowedDeletePost
                };
            }

            _unitOfWork.PostRepository.HardDelete(post);
